...
static void enable_interrupts(struct uart16550 *dev)
{
...
static void disable_interrupts(struct uart16550 *dev)
{
...
static void set_communication_params(struct uart16550 *dev)
{
...
irqreturn_t uart_16550_interrupt_handle(int irq_no, void *dev_id)
{
...
static int uart16550_init_minor(int minor)
{
	...
	/* Initialize HW */
	disable_interrupts(&devs[minor]);
	set_communication_params(&devs[minor]);
	enable_interrupts(&devs[minor]);
